...
export default function Alert(alertMessage: AlertProps) {
  ...
  const color = alertMessage.isSecure ? "bg-red-400" : "bg-green-300";
  return (
    <AnimatePresence>
      {message && (
        <motion.div
          className="w-full z-50 flex fixed top-10 justify-center"
        ...
        >
          <div
            className={`${color} flex p-4 relative h-1/2 wrap-anywhere text-white w-1/3`}
          >
